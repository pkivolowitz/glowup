...
from the emitter registry (e.g., ``screen``), manages its lifecycle,
and feeds it frames received via MQTT or UDP.  This is how a Jetson
drives a local LED matrix from a remote orchestrator.
