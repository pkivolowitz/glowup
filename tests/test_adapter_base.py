...
class TestMqttAdapterBaseConstruction(unittest.TestCase):
    ...
    def test_stores_subscribe_prefix(self) -> None:
        adapter = StubMqttAdapter(subscribe_prefix="sensors")
        self.assertEqual(adapter._subscribe_prefix, "sensors")
...
class TestMqttAdapterBaseWatchdog(unittest.TestCase):
    ...
    # gave false confidence that let a production zombie bug
    # recur (see feedback_adapter_watchdog_test_gap in project
    # memory).  The tests below replace them with real exercises
    # of the actual _watchdog_check and _recover_from_silence
    # methods.
