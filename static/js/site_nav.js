 ...
 *   into every HTML file.  Adding a new dashboard once revealed the
 *   defect: if you forget to paste both pieces, the new page
 ...
 *   (e.g. "/photos" stays active on "/photos/foo").
...
(function () {
    ...
    function render(links) {
        ...
        // Otherwise create one with inline styles and prepend to <body>.
        // New dashboards need
        ...
        links.forEach(function (link) {
            ...
            // still highlight their parent nav link).  The
