...
control, and a foundation for distributed sensors — install
...
From there, you can add sensors, operators, MQTT, or distributed
workers without changing the core model.
