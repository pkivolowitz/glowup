...
Any GlowUp component that should run unattended — the server,
adapter processes, distributed agents, emitters, or the MQTT
broker — needs to survive reboots and restart on failure.
