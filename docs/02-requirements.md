...
lighting.  Each transport, sensor family, and distributed capability
...
always-on coordination, scheduling, sensors, MQTT, or distributed
...
### Audio Output (audio-reactive effects, speakers)
