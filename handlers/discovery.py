...
class DiscoveryHandlerMixin:
    ...
    # user-facing name used in the REST API.
    ...
    def _handle_post_adapter_restart(self, name: str) -> None:
        ...
        Restarts a named adapter daemon thread.  Used by the
        dashboard.  Adapters that are not present (not configured or
        import failed) return 404.

        Args:
            name: Adapter name (printer, mqtt, matter).
        """
